...
```
For example, displacement is positively correlated to cylinder numbers, city mpg is positively correlated to highway mpg, and cylinder number is negatively correlated to city or highway mpg. Those relationship make sense to me. Non of them is surprising.
